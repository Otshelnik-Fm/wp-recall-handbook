...
== FAQ ==
- Имейте под рукой актуальный справочник по ссылкам к WP-Recall

- В админке вашего сайта переходим "WP-Recall" -> "Handbook"
...
= 2017-05-05 =
v3.0
* Информация приведена к WP-Recall 16-й версии
...
v2.0 
* Адаптивный дизайн
* Загрузка стилей только там где они нужны
* Добавлена вкладка "Сервис CodeSeller.ru" - Секреты, советы, рекомендации. Всё об этом сайте.
* Обновлена информация, актуализирована и добавлена

= 2016-07-19 =
v1.1.0
* информация приведена в актуальный, для 15-й версии WP-Recall, вид.
